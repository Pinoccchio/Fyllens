...
class AppColors {
  ...
  static const Color primaryGreen = Color(
    0xFF2E7D32,
  ); // green[800] - 4.5:1 contrast on white
  ...
  static const Color primaryGreenModern = Color(
    0xFF66BB6A,
  ); // Brighter, more vibrant green
  static const Color accentMint = Color(
    0xFF81C784,
  ); // Mint green for highlights
  static const Color backgroundSoft = Color(
    0xFFFAFAFA,
  ); // Softer than F5F5F5 for modern cards
  ...
  static const Color textPrimary = Color(
    0xFF212121,
  ); // Almost black - 16.1:1 contrast
  static const Color textSecondary = Color(
    0xFF757575,
  ); // Medium gray - 4.6:1 contrast
  static const Color textHint = Color(
    0xFF9E9E9E,
  ); // Light gray - 2.8:1 (for hints only)
