...
class PlantDetailPage extends StatelessWidget {
  ...
  List<Widget> _getGrowingConditions(String plant) {
    switch (plant.toLowerCase()) {
      case 'rice':
        return [
          _buildConditionItem(Icons.wb_sunny, 'Sunlight', 'Full sun (6-8 hours daily)'),
          _buildConditionItem(Icons.water_drop, 'Water', 'Flooded conditions preferred'),
          _buildConditionItem(Icons.grass, 'Soil pH', '5.5 to 6.5 (slightly acidic)'),
        ];
      case 'corn':
        return [
          _buildConditionItem(Icons.wb_sunny, 'Sunlight', 'Full sun (8+ hours daily)'),
          _buildConditionItem(Icons.water_drop, 'Water', 'Regular watering, 1-2 inches weekly'),
          _buildConditionItem(Icons.grass, 'Soil pH', '6.0 to 7.0 (neutral to slightly acidic)'),
        ];
      case 'okra':
        return [
          _buildConditionItem(Icons.wb_sunny, 'Sunlight', 'Full sun (6-8 hours daily)'),
          _buildConditionItem(Icons.water_drop, 'Water', 'Moderate, consistent moisture'),
          _buildConditionItem(Icons.grass, 'Soil pH', '6.5 to 7.0 (slightly acidic to neutral)'),
        ];
      case 'cucumber':
        return [
          _buildConditionItem(Icons.wb_sunny, 'Sunlight', 'Full sun (6-8 hours daily)'),
          _buildConditionItem(Icons.water_drop, 'Water', 'Consistent moisture, avoid waterlogging'),
          _buildConditionItem(Icons.grass, 'Soil pH', '6.0 to 7.0 (slightly acidic to neutral)'),
        ];
      default:
        return [
          _buildConditionItem(Icons.wb_sunny, 'Sunlight', 'Full sun recommended'),
          _buildConditionItem(Icons.water_drop, 'Water', 'Regular watering'),
          _buildConditionItem(Icons.grass, 'Soil pH', '6.5 to 7.0 (neutral)'),
        ];
    }
  }
}
